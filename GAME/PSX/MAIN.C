...
{
	long* warningScreen = LOAD_ReadFile("\\kain2\\game\\psx\\warning.tim", 0xB);
...
void MAIN_ShowLegalWarningScreen(struct GameTracker* gameTracker)
{
	long* warningScreen = LOAD_ReadFile("\\kain2\\game\\psx\\mainmenu\\legal.tim", 0xB);
